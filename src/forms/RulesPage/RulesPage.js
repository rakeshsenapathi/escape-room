        ...
        <div className="rules">
            <div className="rules__box">
                <div className="rules__heading">
                    <h1 className="heading-primary heading-primary--sub ut-margin-bottom-medium">What is this game about?</h1>
                    ...
                    <div className="rules__points">
                        <h1 className="heading-primary ut-margin-bottom-medium">Rules</h1>
